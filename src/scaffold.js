...
class Scaffold extends Component {
  componentDidMount() {
    document.getElementById('alignmentjs-scaffold-div')
  ...
  render() {
    ...
    const { sequence_data, scroll_broadcaster, width, height } = this.props,
      ...
      guide_width = this.props.width*scroll_broadcaster.viewport_pixel_width/scroll_broadcaster.full_pixel_width,
      guide_height = this.props.height*scroll_broadcaster.viewport_pixel_height/scroll_broadcaster.full_pixel_height,
      line_style = {stroke: 'red', strokeWidth: '1px'};
    return (<div id='alignmentjs-scaffold-div'>
      <svg
        width={width}
        height={height}
        id='alignmentjs-scaffold'
      >
        <rect
          x={0}
          y={0}
